...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-path" },
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'indent-o-matic'}, { event = "BufEnter *" }, _G.packer_plugins)]]
